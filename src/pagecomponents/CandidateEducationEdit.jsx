...
const CandidateEducationEdit = (props) => {
    ...
    try {
      ...
      if (getEdDetails.data.responseCode == "0") {
        ...
        Swal.fire({
          ...
          showConfirmButton: false,
          background: "rgb(27 123 84)",
          html: `<p style="color: white;letter-spacing: 1px;font-weight:bold;margin: 0px ;font-family: Montserrat, sans-serif;">Deleted Successfully</p>`,
          showClass: {
            popup: "animate__animated animate__fadeInLeft",
          },
          hideClass: {
...
const edListData = filteredData[0];
    ...
    setData({
      ...
      degree: edListData.degree,
      fieldOfStudy: edListData.fieldOfStudy,
      startDateMonth: edListData.startDateMonth,
      startDateYear: edListData.startDateYear,
      endDateMonth: edListData.endDateMonth,
      endDateYear: edListData.endDateYear,
      gradePercentage: edListData.gradePercentage,
    ...
    if (confirmResult.isConfirmed) {
      ...
      try {
        const savedData = await axiosInstance.post(
          "http://" + url + ":" + port + "/" + "candidateEducationUpdate",
          data,
          cfg
        );
...
export default CandidateEducationEdit;
